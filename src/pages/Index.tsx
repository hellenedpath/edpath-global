  ...
  return (
    <>
      <section className="relative text-primary-foreground overflow-x-clip">
        ...
        <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-[52%_48%] gap-10 lg:gap-12 items-start pt-10 md:pt-12 lg:pt-14 pb-8 md:pb-10 lg:pb-12 lg:min-h-[48vh]">
          {/* Left column: text */}
          <div className="flex flex-col justify-start max-w-xl">
            ...
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.15] tracking-[-0.02em] text-white">
              {t("home.title")}
            </h1>
            <p className="mt-12 text-lg md:text-xl text-primary-foreground/80 leading-relaxed font-sans max-w-md">
              {t("home.subtitle")}
            </p>
            <a
              href="#destinos"
              className="group mt-14 inline-flex items-center gap-2.5 rounded-xl bg-crimson px-8 py-4 text-sm font-semibold tracking-wide text-white shadow-[0_4px_16px_-4px_hsl(var(--crimson)/0.45)] hover:bg-crimson/90 hover:shadow-[0_8px_24px_-6px_hsl(var(--crimson)/0.55)] hover:-translate-y-0.5 transition-all duration-300 w-fit"
            >
              {t("home.ctaChoose")}
