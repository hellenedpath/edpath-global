  ...
  return (
    <>
      <section className="relative text-primary-foreground overflow-x-clip">
        ...
        <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-[52%_48%] gap-10 lg:gap-12 items-start pt-16 md:pt-20 lg:pt-24 pb-20 md:pb-24 lg:pb-28">
          {/* Left column: text */}
