export const pt = {
  nav: {
    ...
    myPath: "Meu caminho",
    cta: "Começar",
    discoverMyPath: "Descobrir meu caminho",
  ...
  canadaNav: {
    ...
    prepare: "Preparar",
    arrive: "Chegar",
    discover: "1. Descobrir",
    planPhase: "2. Planejar",
    preparePhase: "3. Preparar",
    live: "4. Viver",
  ...
  countries: {
    ...
    advantages: {
      canada: [
        "Ensino reconhecido mundialmente",
        "Ambiente multicultural e seguro",
        "Bom custo-benefício entre os principais destinos",
      ],
      usa: [
        "Universidades de referência mundial",
        "Enorme variedade de cursos e áreas",
        "Vida de campus vibrante",
      ],
      uk: [
      ...
      australia: [
        "Ensino de alta qualidade e campi modernos",
        "Excelente qualidade de vida",
        "Ambiente seguro e acolhedor",
      ],
      ireland: [
        "Universidades de excelência (Trinity College Dublin)",
        "Diplomas respeitados globalmente",
        "Ensino em inglês, forte ligação com a indústria",
      ],
    },
  },
  canadaSteps: {
  ...
  healthPage: {
    ...
    mandatory: {
      ...
      body: "Study permit não dá direito automático ao plano público. A maioria das províncias tem carência — durante esse período você precisa de seguro privado. Muitas instituições já exigem seguro próprio e incluem no valor. Confirme antes de viajar: atendimento sem cobertura pode custar milhares.",
    },
    provinces: {
      title: "Cobertura por província",
      intro: "Regras e prazos mudam. Confirme sempre com a saúde pública da província e com sua instituição.",
      officialLink: "Site oficial do plano",
      rows: [
        { name: "Ontário (OHIP)", body: "Study permit de 12+ meses pode qualificar, com espera de cerca de 3 meses. Seguro privado é essencial nesse período.", url: "https://www.ontario.ca/page/apply-ohip-and-get-health-card" },
        { name: "British Columbia (MSP)", body: "Há carência; muitos estudantes usam o plano da instituição antes de entrar no MSP.", url: "https://www2.gov.bc.ca/gov/content/health/health-drug-coverage/msp/bc-residents" },
        { name: "Quebec (RAMQ)", body: "Geralmente exige seguro privado, salvo acordo de seguridade social do seu país com o Quebec. A instituição costuma impor seu próprio plano.", url: "https://www.ramq.gouv.qc.ca/en/citizens/health-insurance" },
        { name: "Alberta (AHCIP)", body: "Cobre titulares de study permit elegíveis; confirme carência e inscrição.", url: "https://www.alberta.ca/ahcip" },
        { name: "Manitoba (Manitoba Health)", body: "Cobre titulares de study permit elegíveis; confirme carência e inscrição.", url: "https://www.gov.mb.ca/health/mhsip/registration.html" },
        { name: "Nova Scotia (MSI)", body: "Cobre titulares de study permit elegíveis; confirme carência e inscrição.", url: "https://novascotia.ca/dhw/msi/" },
      ],
      dependentsTitle: "E os dependentes?",
      dependentsBody: "Cônjuge e filhos nem sempre entram automaticamente. Muitas vezes precisam de inscrição e pagamento separados (ex.: UHIP em Ontário cobre dependentes com taxa extra). Confirme quem está coberto antes de contar com isso.",
    },
    daily: {
      title: "Como funciona no dia a dia",
      cards: [
        { name: "Médico de família", body: "Cuidado contínuo e encaminhamentos. Pode demorar meses ou anos para conseguir." },
        { name: "Walk-in clinic", body: "Sem agendamento. Para problemas leves: resfriados, infecções, receitas simples." },
        { name: "Linha 811", body: "Enfermeira 24h por telefone. Indica se você deve ir à clínica, pronto-socorro ou ficar em casa." },
    ...
    notCovered: {
      ...
      body: "Mesmo com o plano provincial, quase todo o país exclui: dentista, óculos, exames de vista e a maioria dos medicamentos. Esses custos saem do seu bolso ou de seguro complementar. Para famílias com crianças, o dentista é o gasto extra mais frequente — planeje no orçamento.",
    },
    footerNote: "A EdPath dá informação, não assessoria de imigração ou médica. Regras, prazos e cobertura mudam por província — confirme sempre nas fontes oficiais (IRCC e saúde pública provincial).",
  ...
  before: {
    ...
    checks: {
      ...
      subtitle: "Confira cada item antes de se inscrever em um programa.",
      dli: {
        title: "Verifique se a instituição é uma DLI",
        content:
          "Só instituições reconhecidas como Designated Learning Institution (DLI) podem receber estudantes internacionais. Sem o código DLI, não é possível obter o permisso de estudo. Sempre confirme o status no site oficial do governo canadense antes de pagar qualquer taxa.",
      },
      pgwp: {
        title: "Verifique a elegibilidade para PGWP",
        content:
          "O Post-Graduation Work Permit (PGWP) permite trabalhar no Canadá após a graduação. A elegibilidade depende do código do programa (CIP), do idioma de instrução e do tempo de duração. Nem todo curso em uma DLI gera direito a PGWP.",
        link: "Confira as regras oficiais do IRCC",
      },
      credential: {
      ...
      duration: {
        ...
        content:
          "Compare o tempo total do curso com a carga horária, a grade e os requisitos de cooperação. Some mensalidades, taxas, materiais, seguro-saúde e custo de vida. Um programa de 8 meses pode custar muito mais do que o valor anunciado.",
      },
      rcic: {
        title: "Para decisões de imigração, consulte um RCIC",
        content:
          "Consultores de imigração Regulated Canadian Immigration Consultants (RCIC) são os únicos profissionais autorizados a dar aconselhamento de imigração no Canadá. Escolhas equivocadas no visto podem atrasar ou cancelar seus planos.",
      },
    },
    scams: {
      ...
      action: {
        title: "O que fazer",
        items: [
          "Confirme o status da instituição no site oficial do governo.",
          "Pague taxas e mensalidades diretamente para a instituição.",
          "Guarde todos os contratos, recibos e comunicações por escrito.",
          "Consulte um RCIC licenciado para decisões de visto e imigração.",
        ],
      },
    },
    disclaimer: {
  ...
  programs: {
    ...
    group: {
      ...
      physical_sciences: "Ciências Físicas e Naturais",
      construction_trades: "Construção e Ofícios",
      mechanics_maintenance: "Mecânica e Manutenção",
      math_statistics: "Matemática e Estatística",
      transport: "Transporte",
      architecture_design: "Arquitetura e Design",
      manufacturing: "Produção e Manufatura",
      business: "Negócios e Gestão",
      services_culinary: "Serviços e Culinária",
      agriculture: "Agricultura e Meio Ambiente",
      safety_defense: "Segurança e Defesa",
      humanities_social: "Ciências Humanas e Sociais",
      interdisciplinary_sciences: "Ciências (Interdisciplinar)",
  ...
  highSchools: {
    ...
    guide: {
      custody: {
        ...
        body:
          "Esta é uma das principais dúvidas de quem vai estudar sendo menor de idade — e a regra oficial do IRCC é clara. Quem é considerado 'menor' depende da província: a maioridade é 18 anos em Alberta, Manitoba, Ontário, PEI, Quebec e Saskatchewan; e 19 anos em British Columbia, New Brunswick, Newfoundland e Nova Scotia. Menor de 17 anos precisa vir com o pai ou responsável legal, ou ter um custodian (custódia) no Canadá — um adulto responsável, cidadão ou residente permanente, que cuida do dia a dia do aluno. Entre 17 e a maioridade, a custódia é opcional, mas o oficial de imigração pode exigir conforme o caso. O documento é o formulário IMM 5646 (Custodianship Declaration), de duas páginas: a página 1 é assinada e reconhecida em cartório pelo custodian no Canadá; a página 2, pelos pais no país de origem. Na prática, a maioria dos School Boards organiza homestay, e isso costuma resolver acomodação e custódia de uma vez.",
      },
      homestay: {
        ...
        redFlags: [
          ...
          "Não há um contato de emergência que responda rápido",
          "O custo é muito acima da média (CAD $950–$1.000/mês) sem justificativa",
          "Ninguém do School Board acompanha ou fiscaliza a casa",
          "O aluno relata isolamento, fome ou frio nas primeiras semanas e ninguém age",
        ],
        questionsTitle: "Pergunte antes de aceitar",
        questions: [
          "O homestay é organizado e fiscalizado pelo próprio School Board? (prefira que sim)",
          "Quem é o contato em emergências e em quanto tempo responde?",
          "O que exatamente está incluso: refeições, transporte, internet?",
          "Posso trocar de família se não der certo, e como?",
  ...
  assistant: {
    ...
    suggestions: [
      ...
      "Quais instituições existem em Ontário?",
    ],
